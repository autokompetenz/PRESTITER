...
const data = {
  ...
  description: 'Facture impayée, panne de voiture, frais médicaux, loyer en retard, coupure d\'électricité — quand l\'urgence ne peut pas attendre. Notre prêt d\'urgence de 100€ à 300€ est traité en priorité avec un délai de réponse de quelques heures et un virement sous 24h si accepté.',
  avantages: [
  ...
  exemple: { icon: '🚗', title: 'Thomas, 35 ans, panne de voiture', scenario: 'Plus de voiture pour aller au travail. Réparation urgent de 250€. Prêt urgence de 250€ sur 2 mois, accepté en 4h.', mensualite: '127,34 €' },
  conditions: [
  ...
  faq: [
    ...
    { q: 'Puis-je obtenir plus de 300 € en urgence ?', r: 'Pour une urgence, le plafond est de 300€. Au-delà, orientez-vous vers notre prêt personnel.' },
  ],
}
