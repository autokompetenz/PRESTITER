...
const data = {
  ...
  description: 'Le prêt personnel Prestiter est notre offre phare. De 100€ à 600€, sans aucun justificatif d\'utilisation. Vous empruntez pour ce que vous voulez : voyage, électroménager, fêtes, dépenses imprévues, loisirs. Pas de questions, pas de paperasse.',
  avantages: [
  ...
  exemple: { icon: '✈️', title: 'Sofia, 28 ans, a financé son voyage', scenario: 'Sofia voulait rendre visite à sa famille au Maroc sans attendre plusieurs mois d\'économies. Prêt personnel de 300€ sur 6 mois.', mensualite: '51,13 €' },
  conditions: [
