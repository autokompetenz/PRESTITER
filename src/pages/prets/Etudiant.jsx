...
const data = {
  ...
  badge: 'Étudiant',
  path: '/prets/etudiant',
  minMontant: 100, maxMontant: 400,
  minDuree: 3, maxDuree: 8,
  cibles: ['Étudiants', 'Alternants', 'Jeunes actifs 18-26 ans'],
  description: 'Les banques ne prêtent pas aux étudiants — nous si. Notre prêt étudiant de 100€ à 400€ est conçu pour les jeunes sans revenus fixes ou avec de faibles ressources. Mensualités légères, conditions souples, et aucune discrimination liée à votre situation.',
  avantages: [
  ...
  exemple: { icon: '📚', title: 'Lucas, 21 ans, étudiant en licence', scenario: 'Besoin d\'un ordinateur portable pour ses cours et ses examens. Prêt étudiant de 200€ sur 4 mois, accepté sans justificatif de revenus.', mensualite: '50,75 €' },
  conditions: [
    { title: 'Âge', text: 'De 18 à 26 ans' },
    { title: 'Montant', text: 'De 100 € à 400 €' },
