...
const data = {
  ...
  description: 'Vous êtes indépendant et les banques vous ignorent ? Notre prêt professionnel de 200€ à 3 000 000€ est fait pour vous. Revenus variables acceptés, pas de bilan comptable exigé. Achetez du matériel, financez un déplacement ou lancez votre activité.',
  avantages: [
  ...
  exemple: { icon: '💻', title: 'Camille, freelance en design', scenario: 'Son ordinateur a rendu l\'âme en pleine mission. Prêt pro de 3 000€ sur 8 mois pour un remplacement urgent.', mensualite: '383,50 €' },
  conditions: [
